...
void Gll :: insertss()
{
     ...
     {
          cout<<"Enter the name of chapter in which you want to insert"<<endl;
          cin>>ch;
          temp=head;
          if(temp->flag==0)
          {
               ...
               while(temp!=NULL)
               {
                    if(!strcmp(ch,temp->name))
                    {
                         cout<<"Enter the name of the section in which you want to insert"<<endl;
                         cin>>ch;
                         if(temp->flag==0)
                         {
                              cout<<"No sections";
